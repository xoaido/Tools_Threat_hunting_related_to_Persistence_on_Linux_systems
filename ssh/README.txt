...
Function 1: SSH authorized_keys2 Files (Find authorized_key2)
...
Function 2: Check file /etc/ssh/sshd_config
    - Case 1: ALert when Remote Root login via SSH is allowed
    - Case 2: Alert when password is using for SSH 

Function 3: Check passphrase for Private key in folder .ssh
    - Find private key file
    - Check whether that key using passphrase


Function 4: Duplicate Keys (Check duplicated key in authorized_keys file)
...
Function 5: Excessive Keys (Check excessive key in authorized_keys file (10 keys here))
...
Function 6: SSH Key Options (Check for option set in authorized_keys file)
...
Function 7: Check for the modification of authorized_keys file in a limited time (24h here) (Optional)
